...
if "!test_type!" == "modulewise" (
        ...
        mkdir ../AutomationResult/!environment!/!module!/"!folderName!""

        :: Generate the Allure report
        call allure generate --single-file ../AllureReport -o ../AutomationResult/!environment!/!module!/"!folderName!"

        timeout /t 15 /nobreak

@REM         start "" "../AutomationResult/!environment!/!module!/"!folderName!/index.html"
        ...
        :: Create the directory in AutomationResult
        mkdir ../AutomationResult/!environment!/!test_type!/"!folderName!""

        :: Generate the Allure report
        call call allure generate --single-file ../AllureReport -o ../AutomationResult/!environment!/!test_type!/"!folderName!"

        timeout /t 15 /nobreak

@REM         start "" "../AutomationResult/!environment!/!test_type!/"!folderName!/index.html"
    )
)
